...
#filename = joinpath(folder, "n40d60n40d60") #no
filename = joinpath(folder, "n30d40")  #ok
#filename = joinpath(folder, "n30d40n10d20")  #no
#filename = joinpath(folder, "n30d40n20d30")  #no
#filename = joinpath(folder, "n30d40n0_1d0_1")  #ok
#filename = joinpath(folder, "n40d60n00d00l")  #ok
